...
@EnableJpaRepositories("my.restserver.repository")
...
public class JPAConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		localContainerEntityManagerFactoryBean.setPackagesToScan(new String[] { "my.restserver.entity" });
